...
const faq = [
  ...
  },
  {
    ...
    text: "The patch can be found in the <a href='http://www.discord.gg/pchal'>Discord</a>. /n Make sure to read the rules and agree to them. Afterwards go into the #emerald-kaizo channel and check the pinned messages. The patch is linked there."
  },
  {
...
export { maintext, nuzlocke_rules, faq };